...
- Docs: new `docs/adr/` architecture decision records folder; ADR-0001 documents the thumbnail generation strategy — why decentralized kind 1063 thumbnail discovery and multiple thumbnail sizes in video events were rejected, and recommends multiple imgproxy failover + client-side canvas resize as fallback
