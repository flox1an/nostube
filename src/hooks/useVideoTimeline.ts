...
*/
  ...
  useEffect(() => {
    ...
    console.log(`[${seq}] lastLoaded:`, lastLoaded, 'time since last load:', lastLoaded ? Date.now() - lastLoaded : 'undefined');
  ...
  console.log(`[${seq}] useVideoTimeline returning, videos count:`, videos.length, 'videosLoading:', videosLoading);
