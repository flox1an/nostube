declare global {
  ...
  namespace JSX {
    interface IntrinsicElements {
      ...
      'media-video': React.DetailedHTMLProps<React.VideoHTMLAttributes<HTMLVideoElement>, HTMLVideoElement>;
      ...
      'media-duration-display': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
